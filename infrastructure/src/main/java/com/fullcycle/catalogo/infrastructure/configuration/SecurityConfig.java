        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    authorize
                            ...
                            .requestMatchers(antMatcher("/genres*")).hasAnyRole(ROLE_ADMIN, ROLE_GENRES)
                            .requestMatchers(antMatcher("/videos*")).hasAnyRole(ROLE_ADMIN, ROLE_VIDEOS)
                ...
                .headers(headers -> {
                    headers.frameOptions((Customizer<HeadersConfigurer<HttpSecurity>.FrameOptionsConfig>) FrameOptionsConfig::sameOrigin);
                })
                .build();
    }
    ...
    static class KeycloakAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        ...
        private Stream<String> extractResourceRoles(final Jwt jwt) {
            ...
            final Function<Map.Entry<String, Object>, Stream<String>> mapResource = resource -> {
                ...
                final var roles = value.getAsJsonArray(ROLES).asList();
                return roles.stream()
